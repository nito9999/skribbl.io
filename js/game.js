((h, c, d, P) => {
    ...
    function jt(e) {
        ...
        ((t = e)[0] != Ze ? t[0] == Xe && 0 <= t[2] && t[2] < C.width && 0 <= t[3] && t[3] < C.height : (a = t[3], o = t[4], r = t[5], i = t[6], t = Math.ceil(t[2] / 2), n = (a + r) / 2, o = (o + i) / 2, r = Math.abs(r - a) / 2, a = Math.abs(i - i) / 2, (i = {
            ...
            x2: C.width + t + r,
            y2: C.height + t + a
        }).x1 < n && n < i.x2 && i.y1 < o && o < i.y2)) ? (v.push(e), x == M && Kt(Zt(e))) : console.log("IGNORED COMMAND OUT OF CANVAS BOUNDS")
    }
    ...
    function en(e) {
        if (L.id == Z && M == x && -1 != xt) {
            ...
            bt == Je && (e = qt, 0 <= ft && (e = (e - Qe) * q(ft, 0, 1) + Qe), l = Math.ceil(.5 * e), s = q(Math.floor(gt[0]), -l, C.width + l), o = q(Math.floor(gt[1]), -l, C.height + l), r = q(Math.floor(b[0]), -l, C.width + l), i = q(Math.floor(b[1]), -l, C.height + l), t = t, e = e, a = s, o = o, r = r, i = i, n = [Ze, t, e, a, o, r, i]), null != n && jt(n)
        }
        var a, o, r, i, l, s
    }
    ...
    $n.prototype.addSound = function(e, t) {
        ...
        this.addSound(kn, "https://nito946.github.io/skribbl.io/audio/roundStart.ogg"), this.addSound(wn, "https://nito946.github.io/skribbl.io/audio/roundEndSuccess.ogg"), this.addSound(Cn, "https://nito946.github.io/skribbl.io/audio/roundEndFailure.ogg"), this.addSound(qn, "https://nito946.github.io/skribbl.io/audio/join.ogg"), this.addSound(xn, "https://nito946.github.io/skribbl.io/audio/leave.ogg"), this.addSound(Mn, "https://nito946.github.io/skribbl.io/audio/playerGuessed.ogg"), this.addSound(Ln, "https://nito946.github.io/skribbl.io/audio/tick.ogg")
    ...
    adplayer = null;
    try {
        aiptag.cmiiid.player.push(function() {
            console.log("ad player loaded"), ooooplayer = new aipPlayer({
                AD_WIDTH: 960,
                AD_HEIGHT: 540,
                AD_FULLSCREEN: !1,
                AD_CENTERPLAYER: !0,
    ...
    }), D([Kn, Fn], "change", se), D(Vn, "click", function() {
        var t, e, n, a, o;
        n = h.location.href, o = "", n = n.split("?"), t = o = 1 < n.length ? (o = "" + n[1]).substring(0, a) : o, Nn || (e = "" != t ? "id=" + t : "lang=" + Fn.value, Me(), Jn(!0), ta(function() {
            Qn(En, e, function(e) {
